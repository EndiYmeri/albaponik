...
<?php get_header(); ?>
    ...
    <main class="contact-page-template container mx-auto">
        <div class="contact-info">
            <div class="flex justify-center flex-col md:flex-row py-3 my-4 md:py-5 md:my-8">
                ...
                <div class="grid justify-items-center border-none md:border-l md:border-gray md:border-r  md:px-10 md:mx-10 my-4 md:my-0">
                ...
                <div class="grid justify-items-center">
                    <a href="https://goo.gl/maps/TbeeNkybcwJXuqwJ6" target="_blank">
                        <div class="flex items-center justify-center gap-4 mb-2">
                            <h3 class="text-3xl font-semibold">
